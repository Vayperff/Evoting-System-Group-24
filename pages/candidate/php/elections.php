...
$email1 = $fetchAdmin->email;
$sqlcandidate1 = $mysqli->prepare("SELECT * FROM candidates WHERE election_status = 0  AND email = ?");
$sqlcandidate1->bind_param("s",$email1);
$sqlcandidate1->execute();
$rescandidates  = $sqlcandidate1->get_result();



$sqlcandidate2 = $mysqli->prepare("SELECT * FROM candidates WHERE election_status = '1'  AND email = ?");
$sqlcandidate2->bind_param("s",$email1);
$sqlcandidate2->execute();
$rescandidates2  = $sqlcandidate2->get_result();
