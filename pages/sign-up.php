...
<body class="">
  ...
  <main class="main-content  mt-0">
   ...
   <div class="input-group input-group-outline mb-3">
    <button type="button" class="btn btn-dark w-100" style="background-image: url('system-image.png'); background-size: fit;"  id="uploadBtn">Upload Profile Image</button>
...
<div class="mb-2">
    ...
    <div class="text-center">
        <button type="submit" style="background-image: url('system-image.png'); background-size: fit;" name="signup" class="btn btn-lg bg-gradient-dark btn-lg w-100 mt-4 mb-0">Sign Up</button>
    </div>
</form>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-2 text-sm mx-auto">
                    ...
                    <a href="sign-in.php" style="background-image: url('system-image.png'); background-size: fit;" class="text-primary text-gradient font-weight-bold">Sign in</a>
                  </p>
                </div>
              </div>
            </div>
