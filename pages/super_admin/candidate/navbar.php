...
<head>
  ...
  <title>
   Candidate |  Welcome <?= htmlspecialchars($fetchAdmin->candidate_name); ?>
  </title>
  <!--     Fonts and icons     -->
 ...
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 bg-white my-2" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand px-4 py-3 m-0" target="_blank" style="display: block; text-align: center;">
      <img src="../images/candidate_images/<?= $fetchAdmin->candidate_image; ?>" class="navbar-brand-img" alt="main_logo" style="width: 100%; height: 300px !important; max-width: 150px;">
      <span class="ms-1 text-sm text-dark" style="display: block; margin-top: 10px;">
        Welcome Candidate <br> <?= $fetchAdmin->candidate_name; ?>
      </span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark" href="dashboard.php">
          ...
          <span class="nav-link-text ms-1">Your elections</span>
        </a>
        <ul class="list-unstyled ps-3">
          <li><a class="nav-link" href="dashboard.php">Elections you are in</a></li>
          <li><a class="nav-link" href="previous_elections.php">Previous elections</a></li>
...
<div class="ms-md-auto pe-md-3 d-flex align-items-center position-relative" style="flex: 1;">
  ...
  <ul id="pagesDropdown" class="dropdown-menu w-100 shadow-sm show"
    ...
    <li><a class="dropdown-item py-2" href="previous_elections.php">Previous elections you particpated in</a></li>
    
    <li><a class="dropdown-item py-2" href="logout.php">Previous elections you Logout</a></li>
