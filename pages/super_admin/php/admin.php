...
if(isset($_SESSION['super_admin_id'])) {
     ...
     if(isset($_SESSION['super_admin_id'])) {
    $adminId = $mysqli->real_escape_string(filter_var($_SESSION['super_admin_id'],FILTER_SANITIZE_NUMBER_INT));
	$adminId = $mysqli->real_escape_string(filter_var($_SESSION['super_admin_id'],FILTER_SANITIZE_NUMBER_INT));
	$sqlAdmin = $mysqli->prepare("SELECT * FROM admin_sign_up WHERE id = ?");
