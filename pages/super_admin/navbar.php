...
<head>
  ...
  <title>
   Super admin |  Welcome <?= htmlspecialchars($fetchAdmin->username); ?>
  </title>
  <!--     Fonts and icons     -->
 ...
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 bg-white my-2" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand px-4 py-3 m-0" target="_blank" style="display: block; text-align: center;">
      <img src="images/profile_images/<?= $fetchAdmin->image; ?>" class="navbar-brand-img" alt="main_logo" style="width: 100%; height: 300px !important; max-width: 150px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <ul class="list-unstyled ps-3">
          <li><a class="nav-link" href="register_admin.php">Register new admin</a></li>
          <li><a class="nav-link" href="manage_admins.php">Manage Admins</a></li>
          <!--
...
<div class="ms-md-auto pe-md-3 d-flex align-items-center position-relative" style="flex: 1;">
  ...
  <ul id="pagesDropdown" class="dropdown-menu w-100 shadow-sm show"
    ...
    <li><a class="dropdown-item py-2" href="register_admin.php">Register new admin</a></li>
    <li><a class="dropdown-item py-2" href="manage_admins.php">Manage Admins</a></li>
    <!--
