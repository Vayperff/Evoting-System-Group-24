...
if (isset($_POST['signup'])) {
    ...
    */
    ...
    $sql = $mysqli->prepare("INSERT INTO admin_sign_up (username, reg_name, email, phone, password, image, date_format) VALUES (?, ?, ?, ?, ?, ?, ?)");
            ...
            */
            $mail->Body    = "
                <h4>New User Registered:</h4><br>
                 <p>You have successfully been registered as an Admin of Evoting System group 24.  </p>
                 
                <p><strong>Name:</strong> $names</p><br>
                <p><strong>Email:</strong> $email</p><br>
                <p><strong>Phone:</strong> $phone</p><br>
                <p><strong>Registration Number:</strong> $reg_number</p><br>
