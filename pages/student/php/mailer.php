...
if (isset($_POST['send_message'])) {
    ...
    try {
        ...
        $mail->Host = 'mail.skyratesipifalls.com';                // Specify main SMTP server
        $mail->SMTPAuth = true;                                   // Enable SMTP authentication
        $mail->Username = 'info@skyratesipifalls.com';            // SMTP username
        $mail->Password = 'Secret@123$$';                         // SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;          // Enable TLS encryption; 'PHPMailer::ENCRYPTION_SMTPS' uses SSL
